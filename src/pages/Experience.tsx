  ...
  const experiences = [
    {
      ...
      logo: `<img src={${import.meta.env.BASE_URL}skills/lonza.png`,
    ...
    },
    {
      ...
      period: "2020 - 2021",
      type: "Full-time /  Internship",
      logo: `<img src={${import.meta.env.BASE_URL}skills/rit.png`,
    ...
    },
    {
      ...
      type: "Full-time",
      logo: `<img src={${import.meta.env.BASE_URL}skills/vegrow.png`,
      iconContainerClass: "w-16 h-16 bg-white rounded-lg flex items-center justify-center shadow-lg",
      iconImgClass: "w-14 h-14 object-contain",
    ...
    },
    {
      ...
      type: "Full-time",
      logo: `<img src={${import.meta.env.BASE_URL}skills/aequs.png} alt="Aequs Force Consumer" className="w-16 h-16" />`,
      iconContainerClass: "w-16 h-16 bg-white rounded-lg flex items-center justify-center shadow-lg",
      iconImgClass: "w-14 h-14 object-contain",
